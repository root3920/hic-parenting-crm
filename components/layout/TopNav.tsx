...
const ALL_NAV_ITEMS = [
  ...
  { href: '/client-success', label: 'Client Success',  icon: HeartHandshake,  roles: ['admin'] as UserRole[] },
  { href: '/equipo/csm',     label: 'Client Success',  icon: HeartHandshake,  roles: ['csm_ht'] as UserRole[] },
  ...
  { href: '/contacts',     label: 'Clients',      icon: Contact,         roles: ['admin', 'setter'] as UserRole[] },
...
export function TopNav() {
  ...
  return (
    <>
      <motion.header
        className="fixed top-0 inset-x-0 z-50 h-14 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 flex items-center no-print"
